...
<template>
    ...
    <div class="flex justify-end m-2 p-2">
        <RouterLink 
        :to="{name: 'SkillCreate'}" 
        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-800 text-white rounded"
        ...
        <tbody>
            <tr v-for="skill in skills" :key="skill.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4 space-x-2">
                    <RouterLink 
                    :to="{name: 'SkillEdit', params: { id: skill.id } }" class="px-4 py-2 bg-green-500 hover:bg-green-700 text-white rounded"> 
                    Edit 
                    </RouterLink>
